...
import com.hifood.util.DatabaseCleaner;
import com.hifood.util.ResourceUtils;
...
class CadastroRestauranteIT {
	...
	public void setUp() {
		...
		jsonRestauranteCorreto = ResourceUtils.getContentFromResource(
				"/json/sem_erro/restaurante-china-town.json");
		
		jsonRestauranteSemFrete = ResourceUtils.getContentFromResource(
				"/json/com_erro/restaurante-china-town-sem-frete.json");
		
		jsonRestauranteSemCozinha = ResourceUtils.getContentFromResource(
				"/json/com_erro/restaurante-china-town-sem-cozinha.json");
		
		jsonRestauranteComCozinhaInexistente = ResourceUtils.getContentFromResource(
				"/json/com_erro/restaurante-china-town-com-cozinha-inexistente.json");
